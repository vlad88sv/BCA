...
if (usuario_cache('nivel') == NIVEL_empresa)
{
    require_once('PHP/-empleado.amigable.php');
    return;
}
/*
...
$opts['tb'] = db_prefijo.'empleado';

// Name of field which is the unique key
$opts['key'] = 'ID_empleado';

// Type of key field (int/real/string/date etc.)
$opts['key_type'] = 'int';

// Sorting field(s)
$opts['sort_field'] = array('ID_empleado');
