...
$opts['fdd']['nivel'] = array(
  ...
  'select'   => 'T',
  'maxlen'   => 13,
  'values'   => array('visitante','demo','empresa','moderador','administrador'),
  'sort'     => true
);
$opts['fdd']['tipo'] = array(
  'name'     => 'Tipo',
  'select'   => 'T',
  'maxlen'   => 11,
  'values'   => array('contenido','redireccion','include'),
  'sort'     => true
);
