...
function empleado_buscar__vista_consulta_global(&$r, &$arrErrores, &$arrAdvertencias, &$op)
{
    ...
    {
        $tabla .= '<h2>Faltas laborales</h2>';
        $tabla .= '<p>El empleado no tiene faltas laborales registradas en esta empresa</p>';
    }
    $tabla .= '</div>';
    /*****************************************/
